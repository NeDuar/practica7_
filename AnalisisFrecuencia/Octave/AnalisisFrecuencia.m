function [y,yfinal,porcentajes]=AnalisisFrecuencia(x,fs)
    ...
    if nargin==1 % revisa si se ingreso fs o si no toma como valor fs=16000
 ...
 %calculo de energía
     ...
     for i=1:length(x)
        ...
        energiade2a5 =  energiade2a5+sqrt(y(i,1)*y(i,1));
            ...
            energia4 =  energia4+sqrt(y4(i,1)*y4(i,1));
...
% Subplots para las primeras tres graficas
subplot(3,1,1)
stem(n,x)
title('x[n]')
subplot(3,1,2)
...
% Nueva figura para las otras siete graficas
figure(2)
subplot(4,2,1)
fvtool(b,a)
title('FILTRO PARA BANDA PRINCIPAL (2.0-5.0)KHz')
subplot(4,2,2)
fvtool(b1,a1)
